...
NLPModels.hess_op(nlp::NullHessianModel{T, V}, x::AbstractVector; kwargs...) where{T, V} = opZeros(T, nlp.meta.nvar, nlp.meta.nvar)
NLPModels.hprod(nlp::NullHessianModel, x::AbstractVector, v::AbstractVector; kwargs...) = zero(v)
