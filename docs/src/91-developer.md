...
3. Add this repo as a remote:
   ...
   ```bash
   git remote add upstream https://github.com/JuliaSmoothOptimizers/ExactPenalty.jl
   ```
...
- Go back to main screen and click on the latest commit (link: <https://github.com/JuliaSmoothOptimizers/ExactPenalty.jl/commit/main>)
...
- After the merge happens, TagBot will trigger and create a new GitHub tag. Check on <https://github.com/JuliaSmoothOptimizers/ExactPenalty.jl/releases>
- After the release is create, a "docs" GitHub action will start for the tag.
- After it passes, a deploy action will run.
- After that runs, the [stable docs](https://JuliaSmoothOptimizers.github.io/ExactPenalty.jl/stable) should be updated. Check them and look for the version number.
